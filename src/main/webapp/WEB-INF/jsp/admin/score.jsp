...
<head>
    ...
    <script type="text/javascript">
        ...
        function batchaddUser() {
            $("#deviceExport").click(
                function () {
                    var url = '/teacher/topic/exportExcel';
                    location.href = url
                });
...
<div id="tb">
    <div>
        <form action="/teacher/topic/exportExcel" method="get">
            <a href="javascript:openUserAddDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">添加</a>
            <a href="javascript:openUserModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit"
               plain="true">修改</a>
            <a href="javascript:deleteUser()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
            <%--        <a href="javascript:batchaddUser()" class="easyui-linkbutton" iconCls="icon-add" plain="true">导出成绩</a>--%>
