    ...
    <script type="text/javascript">
        ...
        function deleteCourseType() {
            ...
            $.messager.confirm("系统提示", "您确定要删除这<font color=red>" + selectedRows.length + "</font>条数据吗？", function (r) {
                if (r) {
                    $.post("/admin/courseType/delete/" + ids, {}, function (result) {
                        if (result == "success") {
                            $("#dg").datagrid("reload");
                        } else {
        ...
        function openCourseTypeAddDialog() {
            $("#dlg").dialog("open").dialog("setTitle", "添加课程信息信息");
            url = "/admin/courseType/insert";
        }
        ...
        function openCourseTypeModifyDialog() {
            ...
            $("#dlg").dialog("open").dialog("setTitle", "编辑课程信息信息");
            $("#fm").form("load", row);
            url = "/admin/courseType/update/" + row.id;
        }
        ...
        function batchaddCourseType() {
            $("#dlg1").dialog("open").dialog("setTitle", "批量添加课程信息信息");
...
<table id="dg" title="课程信息管理" class="easyui-datagrid"
       ...
       url="/admin/courseType/list" fit="true" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="id" width="20" align="center">编号</th>
        <th field="courseName" width="100" align="center">学期类型名称</th>
    </tr>
    </thead>
</table>
<div id="tb">
    <div>
        ...
        <a href="javascript:openCourseTypeModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit"
           plain="true">修改</a>
        <a href="javascript:deleteCourseType()" class="easyui-linkbutton" iconCls="icon-remove" plain="true">删除</a>
        <a href="javascript:batchaddCourseType()" class="easyui-linkbutton"iconCls="icon-add" plain="true">批量增加</a>
    </div>
</div>
...
<div id="dlg1" class="easyui-dialog" style="width:500px;height:180px;padding: 10px 20px"
     closed="true" >
    <div>
        <form id="form_excel" name="form_excel" action="/admin/courseType/DoExcel" method="post"
