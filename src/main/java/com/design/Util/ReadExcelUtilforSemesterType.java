...
//     * @param fielName
     * @return
     */
    public List<SemesterType> getExcelInfo(MultipartFile mFile) {
     ...
     * @throws IOException
     */
    public List<SemesterType> createExcel(InputStream is, boolean isExcel2003) {
        List<SemesterType> semList = null;
        try {
            Workbook wb = null;
     ...
     * @return
     */
    private List<SemesterType> readExcelValue(Workbook wb) {
        // 得到第一个shell
        ...
        List<SemesterType> semList = new ArrayList<SemesterType>();
        // 循环Excel行数
